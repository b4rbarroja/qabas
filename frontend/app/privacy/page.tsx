              ...
              <div className="max-w-3xl">
                ...
                <section id="usage" className="scroll-mt-8">
                  ...
                  <p>
                    ...
                    جُمعت من أجله إلا إذا كان ذلك مطلوبًا قانونيًا أو بموافقتك.
                  </p>
                </section>
                ...
                <section id="sharing" className="scroll-mt-8">
                  ...
                  <p>
                    كما قد يتم الكشف عن معلومات معينة إذا كان ذلك مطلوبًا بموجب
                    القانون أو استجابة لطلب قانوني ملزم.
                  </p>
                </section>
