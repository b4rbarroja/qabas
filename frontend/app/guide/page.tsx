...
const STEPS = [
  ...
  {
    number: "02",
    title: "اكتب مقالتك بالذكاء الاصطناعي",
    description:
      "افتح أي أداة ذكاء اصطناعي تعرفها — مثل ChatGPT أو Gemini — واطلب منه كتابة مقالة كاملة بصيغة Markdown. اطلب مثلاً: «اكتب لي مقالة عن السفر بصيغة Markdown بعناوين وقوائم». ثم انسخ النص الناتج كاملاً.",
    icon: Sparkles,
    href: null,
    hrefLabel: null,
  },
  ...
  },
  {
    ...
    description:
      "بعد موافقة الإدارة يظهر مقالك منسقاً بالكامل في صفحة التدوينات. انسخ رابطه وشاركه مع أصدقائك وقرّائك أينما كانوا.",
    icon: Send,
    href: "/posts",
          ...
          <div className="rounded-2xl border border-primary/10 bg-primary/5 px-6 py-10 md:px-10 md:py-14">
            <div className="max-w-3xl">
              ...
              <p className="mt-5 max-w-2xl text-base leading-8 text-dark/60 md:text-lg">
                دليل بسيط يأخذك خطوة بخطوة — من إنشاء حسابك حتى نشر أول
                مقالة لك — دون الحاجة إلى أي خبرة تقنية. اقرأ الصفحة كاملة،
                أو انتقل مباشرة إلى الخطوة التي تريدها.
              </p>
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-8 rounded-2xl border border-primary/10 bg-primary/5 p-6 sm:p-8">
            ...
            <p className="mb-4 text-sm leading-7 text-dark/60 sm:text-base">
              هذا مثال صغير على الصيغة التي ستطلبها من أداة الذكاء
              الاصطناعي. لاحظ أن العناوين تبدأ بـ ‎#‎، والغامق بين ‎**‎،
              والقوائم بشرطة ‎-‎ — والمنصة تحوّلها تلقائياً إلى شكل جميل
              عند العرض:
            </p>
            <pre
              dir="ltr"
