...
router.post("/", upload.single("userImage"), async (req, res) => {
    try {
        const { name, email, password, bio, selectedCategories, specialization, portfolioUrl, agreeTerms, agreeOriginality, } = req.body;
        ...
        const createdUser = await prisma.user.create({
            data: {
                ...
                agreeOriginality: agreeOriginality === "true" || agreeOriginality === true,
                role: "USER",
            },
        });
